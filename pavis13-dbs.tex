...
%	\parbox{1in}{\scriptsize \centering Link\"oping University}
	\parbox{1in}{\scriptsize \centering Sound Technology Group \\ Link\"oping University}
...
\section*{Acknowledgements}We thank all reviewers for their fruitful comments and Matt Cooper for proof reading. This work was partly supported by grants from the Excellence Center at Linkšping and Lund in Information Technology (ELLIIT) and the Swedish e-Science Research Centre (SeRC), as well as VR grant 2011-4113. The presented concepts have been realized using the Voreen framework (www.voreen.org).
